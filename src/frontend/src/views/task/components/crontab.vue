// copy from https://cloud.tencent.com/developer/article/2195040
<template>
  <div class="v3c">
    <ul class="v3c-tab">
      <li
    ...
    <div class="v3c-content" v-show="tabActive == 2">
      ...
      <!-- 具体分钟数 -->
      <div class="mt-15">
        <el-radio label="3" v-model="state.minute.cronEvery"
          >具体分钟数(可多选)</el-radio
        >
        <el-select
    ...
    <div class="v3c-content" v-show="tabActive == 5">
      ...
      <!-- 3 -->
      <div class="mt-15">
        <el-radio label="3" v-model="state.month.cronEvery"
          >具体月数(可多选)</el-radio
        >
        <el-select
          multiple
